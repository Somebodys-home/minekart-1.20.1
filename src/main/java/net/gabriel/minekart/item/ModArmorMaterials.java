...
public enum ModArmorMaterials implements ArmorMaterial {
    CLOAK("Cloak of Invisibility", 25, new int[] {3, 8, 6, 3}, 19, SoundEvents.ITEM_ARMOR_EQUIP_ELYTRA, 2f, 0f, () -> Ingredient.ofItems((ModItems.VANILLA_ICE_CREAM)))
    ;
